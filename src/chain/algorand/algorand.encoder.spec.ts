...
describe("Algorand Encoding", () => {
	...
	beforeEach(async () => {
		...
		// config get GENESIS_ID
		configServiceMock.get.mockReturnValueOnce(genesisId)
		// config get GENESIS_HASH
		configServiceMock.get.mockReturnValueOnce(genesisHash)
		algorandCrafter = new AlgorandTransactionCrafter(configServiceMock)
	})
